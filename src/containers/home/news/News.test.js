...
describe('News Component', () => {
    beforeEach(() => {
        ArticleData.getDataApple.mockResolvedValue({
            data: { articles: mockArticles },
        });
    });
    const renderComponent = () => render(_jsx(BrowserRouter, { children: _jsx(News, {}) }));
    ...
    it('changes category and refetches data', async () => {
        ArticleData.getDataTesla.mockResolvedValue({
